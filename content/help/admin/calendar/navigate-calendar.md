...
The schedule grid below the Today's Bookings panel shows a rolling 7-day window starting from today.

## Browse by week

Use the **Previous Week** and **Next Week** buttons at the top of the grid to move the window backwards or forwards.
...
When you are viewing any week other than the current one, a **Today** button appears between the navigation buttons. Click it to return to the window anchored on today.

## Jump to a specific date

Use the **date picker** (to the right of the navigation buttons) to select any specific date. The grid switches to a single-day view for that date. Click **Back to Weekly View** to return to the 7-day grid.
...
- The grid shows one instructor at a time. Use the instructor search at the top of the page to switch.
