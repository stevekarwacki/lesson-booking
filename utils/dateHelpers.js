 ...
 * 
 * Provides standardized date creation, parsing, and comparison utilities.
 * All comparisons use timestamps for consistency across timezones.
 * Builds on existing timeUtils.js infrastructure.
 */

const { getUserTimezone } = require('./timeUtils');
